...
def build_title_container(app):
    ...
    app.title_container = toga.Box(style=Pack(direction=ROW, padding=(10, 40, 10, 40)))
...
def build_series_container(app):
    ...
    app.series_container = toga.Box(style=Pack(direction=ROW, padding=(10, 40, 10, 40)))
...
def build_volume_container(app):
    ...
    app.volume_container = toga.Box(style=Pack(direction=ROW, padding=(10, 40, 10, 40)))
